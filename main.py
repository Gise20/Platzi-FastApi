...
class Movie(BaseModel):
    ...
    class Config:
        schema_extra = {
            "Example": {
                "id": 1,
                "title": "Pelicula random",
                "overview": "Overview random random random",
                "year": 2022,
                "rating": 9.8,
                "category": "Accion"
            }
...
def get_moviews_by_category(category: str = Query(min_length=5, max_length=15)) -> List[Movie]:
